...
import io.github.scitia.domain.agile.mapper.BacklogItemResponseMapper;
...
public final class AgileAddBacklogItemToolHandler implements ToolHandler, AgenticBusinessTool {
    ...
    public CompletableFuture<Object> invoke(ToolInvocation invocation) {
        return CompletableFuture.supplyAsync(() -> {
            ...
            return BacklogItemResponseMapper.INSTANCE.apply(flowEngine.run(AgileFlows.BACKLOG_ITEM_FLOW, request));
        });
    }
}
