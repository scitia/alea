package io.github.scitia.domain.agile.flows.process.emission;
...
public final class PublishAgileAuditWaypoint<T> implements EmissionPoint<T> {
    ...
    private static final org.apache.logging.log4j.Logger logger = org.apache.logging.log4j.LogManager.getLogger(PublishAgileAuditWaypoint.class);
